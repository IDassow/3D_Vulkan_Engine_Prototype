...
namespace vWind {
    ...
    SimpleRenderSystem::SimpleRenderSystem(VulkDevice& device, VkRenderPass renderPass)
        : vulkDevice{ device } {
    ...
    void SimpleRenderSystem::renderGameObjects(
        VkCommandBuffer commandBuffer, std::vector<VulkGameObj>& gameObjects) {
        vulkPipeline->bind(commandBuffer);
